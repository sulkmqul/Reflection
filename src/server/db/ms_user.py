...
"""
    sql_insert = """
INSERT OR IGNORE INTO ms_user (ms_user_id, user_name, login_id, login_password, create_user_id, update_user_id, admin_flag) VALUES (1, 'administrator', 'admin', '#reflection', 0, 0, 1);
"""
